...
exports.esQueryTransformer = require('./elastic-query-transformer');
exports.DateKeywords = require('./date-keywords').DateKeywords;

/**
 * @deprecated Use npm library json-stringify-safe instead, better options
 * @param obj
 * @returns {string}
 */
exports.safeJsonStringify = function (obj) {
    const cache = new Set();
...
exports.predicate = require('./predicate');